...
const makeStyles = (t) =>
  StyleSheet.create({
    ...
    nameBlock: {
      alignItems: 'center',
      paddingLeft: t.chrome.identityPl,
      paddingRight: t.chrome.identityPr,
      paddingTop: t.chrome.identityPt,
      paddingBottom: t.chrome.identityPb
    },
    name: {
      fontSize: t.typography.name.size,
      fontWeight: t.typography.name.weight,
      color: t.palette.white,
      lineHeight: 1.2,
      letterSpacing: t.typography.name.spacing,
      textAlign: 'center'
    },
    divider: {
      width: t.chrome.identityDividerWidth,
      height: t.chrome.dividerHeight,
      backgroundColor: t.palette.accentDivider,
      marginVertical: t.chrome.identityDividerMy,
      alignSelf: 'center'
    },
    titleText: {
      fontSize: t.typography.title.size,
      color: t.palette.accentTextSecondary,
      lineHeight: 1.5,
      textAlign: 'center'
    },
    companyText: {
      fontSize: t.typography.company.size,
      fontWeight: t.typography.company.weight,
      color: t.palette.accentTextTertiary,
    ...
    photo: {
      width: '100%',
      height: t.chrome.photoHeight,
      objectFit: 'cover',
      borderRadius: t.chrome.photoBorderRadius
    }
  })
